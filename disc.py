...
consumer_key = 'efEXxyYskXCCGJEAHEDj'
consumer_secret = 'yNurCwqDRHlZIaSSjrsOzTAhUeOwuKcp'
...
discogsclient = discogs_client.Client('ExampleApplication/0.1', user_token="zVthyxfFmZbJVndOUsboKCsroRFBQsEHxtnTdOSc")
...
search_results = discogsclient.search('634904075484', type='UPC')
